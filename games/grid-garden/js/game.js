var game = {
  ...
  level: parseInt(localStorage.getItem('ftol:gridgarden:level'), 10) || 0,
  answers: (localStorage.getItem('ftol:gridgarden:answers') && JSON.parse(localStorage.getItem('ftol:gridgarden:answers'))) || {},
  solved: (localStorage.getItem('ftol:gridgarden:solved') && JSON.parse(localStorage.getItem('ftol:gridgarden:solved'))) || [],
  user: localStorage.getItem('ftol:gridgarden:user') || '',
  changed: false,
  ...
  start: function() {
    ...
    if (!localStorage.getItem('ftol:gridgarden:user')) {
      game.user = '' + (new Date()).getTime() + Math.random().toString(36).slice(1);
      localStorage.setItem('ftol:gridgarden:user', game.user);
    }
  ...
  setHandlers: function() {
    ...
    $('#labelReset').on('click', function() {
      ...
      if (r) {
        ...
        game.answers = {};
        game.solved = [];
        localStorage.removeItem('ftol:gridgarden:level');
        localStorage.removeItem('ftol:gridgarden:answers');
        localStorage.removeItem('ftol:gridgarden:solved');
    ...
    $(window).on('beforeunload', function() {
      game.saveAnswer();
      localStorage.setItem('ftol:gridgarden:level', game.level);
      localStorage.setItem('ftol:gridgarden:answers', JSON.stringify(game.answers));
      localStorage.setItem('ftol:gridgarden:solved', JSON.stringify(game.solved));
