var game = {
  colorblind: (localStorage['ftol:flexboxfroggy:colorblind'] && JSON.parse(localStorage['ftol:flexboxfroggy:colorblind'])) || 'false',
  language: window.location.hash.substring(1) || 'en',
  difficulty: 'easy',
  level: parseInt(localStorage['ftol:flexboxfroggy:level'], 10) || 0,
  answers: (localStorage['ftol:flexboxfroggy:answers'] && JSON.parse(localStorage['ftol:flexboxfroggy:answers'])) || {},
  solved: (localStorage['ftol:flexboxfroggy:solved'] && JSON.parse(localStorage['ftol:flexboxfroggy:solved'])) || [],
  changed: false,
  clickedCode: null,
  ...
  setHandlers: function() {
    ...
    $('#labelReset').on('click', function() {
      ...
      if (r) {
        ...
        game.answers = {};
        game.solved = [];
        localStorage.setItem('ftol:flexboxfroggy:level', 0);
        localStorage.setItem('ftol:flexboxfroggy:answers', '{}');
        localStorage.setItem('ftol:flexboxfroggy:solved', '[]');
    ...
    $(window).on('beforeunload', function() {
      game.saveAnswer();
      localStorage.setItem('ftol:flexboxfroggy:level', game.level);
      localStorage.setItem('ftol:flexboxfroggy:answers', JSON.stringify(game.answers));
      localStorage.setItem('ftol:flexboxfroggy:solved', JSON.stringify(game.solved));
      localStorage.setItem('ftol:flexboxfroggy:colorblind', JSON.stringify(game.colorblind));
