...
function saveGameData() {
    localStorage.setItem("ftol:progressknight:gameDataSave", JSON.stringify(gameData))
}

function loadGameData() {
    var gameDataSave = JSON.parse(localStorage.getItem("ftol:progressknight:gameDataSave"))
...
function resetGameData() {
    localStorage.removeItem("ftol:progressknight:gameDataSave")
    location.reload()
}
