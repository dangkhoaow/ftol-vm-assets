...
const Campaign = {
  KEY: 'ftol:sketchturfbattle:campaign',
  ...
  unlockAll() {
    try { return localStorage.getItem('ftol:sketchturfbattle:unlockAll') === '1'; }
    catch { return false; }
  },
  setUnlockAll(on) {
    try {
      if (on) localStorage.setItem('ftol:sketchturfbattle:unlockAll', '1');
      else localStorage.removeItem('ftol:sketchturfbattle:unlockAll');
    } catch { }
  },
