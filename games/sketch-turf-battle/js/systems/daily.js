...
const Daily = {
  ...
  best() {
    try {
      const v = localStorage.getItem('ftol:sketchturfbattle:daily.' + this.todayKey());
  ...
  submit(score) {
    ...
    try { localStorage.setItem('ftol:sketchturfbattle:daily.' + this.todayKey(), String(score)); } catch { }
    return true;
  },
};
