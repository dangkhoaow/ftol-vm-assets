class SoundService {
    constructor() {
        ...
        this.sfxMuted = true;
        try {
            const saved = JSON.parse(localStorage.getItem("ftol:serversurvivaltd:serverSurvivalSoundPrefs"));
    ...
    _persistPrefs() {
        try {
            localStorage.setItem("ftol:serversurvivaltd:serverSurvivalSoundPrefs",
