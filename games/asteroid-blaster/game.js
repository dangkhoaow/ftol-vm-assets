...
//
// Adapted 2026-07-08 for freetoolonline.com/games/asteroid-blaster.html:
// the bundled vector_battle_regular.typeface.js glyph font (c) 1999 by ck!
// carried no permissive license (copyright notice only, empty license
// fields), so the Text renderer below was rewritten to use a plain canvas
// font instead of that font file. Everything else is unmodified upstream
// logic from dmcinnes/HTML5-Asteroids (MIT).
...
// Plain canvas-font text renderer (2026-07-08 adaptation - replaces the
// original typeface.js vector-glyph renderer; see file header note).
Text = {
  renderText: function (text, size, x, y) {
    this.context.save();
    this.context.font = size + 'px "Courier New", Consolas, monospace';
